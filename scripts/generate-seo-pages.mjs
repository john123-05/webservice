...
const servicePages = [
  {
    ...
    relatedLinks: [
      ...
      { href: 'website-erstellen-lassen-bielefeld.html', title: 'Website erstellen lassen Bielefeld', text: 'Für Unternehmen, die eine neue Website mit klarem Fokus auf Anfragen planen.' },
  ...
  },
  {
    ...
    title: 'Webdesign Bielefeld | Mehr Anfragen mit einer besseren Website',
    description: 'Webdesign in Bielefeld für lokale Unternehmen, die professioneller auftreten, Vertrauen aufbauen und mehr Anfragen über ihre Website gewinnen möchten.',
    eyebrow: 'Webdesign Bielefeld',
    h1: 'Webdesign in Bielefeld für Unternehmen, die mit ihrer Website mehr Anfragen gewinnen wollen',
    introTitle: 'Webdesign mit Fokus auf Sichtbarkeit und Conversion',
    introText: 'Viele Unternehmen suchen nach Webdesign in Bielefeld, meinen damit aber eigentlich mehr Anfragen, mehr Vertrauen und eine Website, die endlich klarer verkauft. Genau darauf ist diese Seite ausgerichtet.',
    ...
    relatedLinks: [
      { href: 'website-erstellen-lassen-bielefeld.html', title: 'Website erstellen lassen Bielefeld', text: 'Für Unternehmen, die eine neue Website von Grund auf planen.' },
  ...
  {
    fileName: 'website-erstellen-lassen-bielefeld.html',
    title: 'Website erstellen lassen Bielefeld | Mehr Anfragen mit einer neuen Website',
    description: 'Website erstellen lassen in Bielefeld für Unternehmen, die eine neue Website mit klarem Fokus auf Sichtbarkeit, Vertrauen und mehr Anfragen möchten.',
    eyebrow: 'Website erstellen lassen Bielefeld',
    h1: 'Website erstellen lassen in Bielefeld für Unternehmen, die online mehr Anfragen wollen',
    introTitle: 'Wenn eine neue Website geschäftlich etwas bringen soll',
    introText: 'Viele Unternehmen suchen nach Website erstellen lassen in Bielefeld, meinen aber in Wirklichkeit mehr als nur eine neue Seite: Sie wollen professioneller wirken, bei Google besser verstanden werden und mehr Anfragen erhalten.',
    points: ['Neue Website mit klarem Fokus auf Anfragen', 'Bessere Botschaft, Struktur und Nutzerführung', 'Professioneller erster Eindruck für lokale Unternehmen', 'Saubere Basis für Sichtbarkeit, SEO und spätere Erweiterungen'],
    detailTitle: 'Was eine neue Website leisten muss',
    detailParagraphs: ['Eine neue Website lohnt sich besonders dann, wenn die bestehende Seite veraltet ist, nicht mehr zu Ihrem Angebot passt oder geschäftlich zu wenig Wirkung erzeugt.', 'Entscheidend ist nicht nur, dass die Website neu aussieht, sondern dass sie Leistungen verständlich erklärt, Vertrauen aufbaut und Besucher konsequent zum nächsten Schritt führt.'],
    relatedTitle: 'Passende Seiten für neue Websites',
    relatedLinks: [
      { href: 'webdesign-bielefeld.html', title: 'Webdesign Bielefeld', text: 'Für die strategische und visuelle Grundlage der neuen Website.' },
      { href: 'website-relaunch-bielefeld.html', title: 'Website Relaunch Bielefeld', text: 'Wenn statt kompletter Neuerstellung eher ein sauberer Neuaufbau sinnvoll ist.' },
      { href: 'webentwicklung-bielefeld.html', title: 'Webentwicklung Bielefeld', text: 'Für die technische Umsetzung und eine saubere Grundlage.' },
    ],
    faq: [
      { question: 'Wann lohnt es sich, eine Website neu erstellen zu lassen?', answer: 'Vor allem dann, wenn die aktuelle Website veraltet wirkt, zu wenig Anfragen bringt oder nicht mehr zu Ihrer Positionierung passt.' },
      { question: 'Ist eine neue Website automatisch auch besser für Google?', answer: 'Nicht automatisch. Sie kann aber deutlich besser für Google und Nutzer aufgestellt werden, wenn Struktur, Inhalte und Technik von Anfang an sauber geplant werden.' },
      { question: 'Was ist der Unterschied zu Webdesign oder Relaunch?', answer: 'Website erstellen lassen ist die Suchanfrage mit der stärksten Kaufabsicht. Inhaltlich überschneidet sie sich mit Webdesign und Relaunch, trifft aber oft Unternehmen, die konkret eine neue Lösung suchen.' },
    ],
  },
  {
  ...
  },
  {
    ...
    title: 'Online Marketing Bielefeld | Mehr Sichtbarkeit und mehr Anfragen',
    description: 'Online Marketing in Bielefeld für Unternehmen, die Website, Sichtbarkeit und Nachfrage strategisch zusammenführen und mehr Anfragen gewinnen möchten.',
    eyebrow: 'Online Marketing Bielefeld',
    h1: 'Online Marketing in Bielefeld für Unternehmen, die aus Sichtbarkeit mehr Anfragen machen wollen',
  ...
  },
  {
    ...
    title: 'Website Relaunch Bielefeld | Mehr Anfragen statt veralteter Website',
    description: 'Website Relaunch in Bielefeld für Unternehmen mit veralteter, unklarer oder schwacher Website, die wieder mehr Anfragen bringen soll.',
    eyebrow: 'Website Relaunch Bielefeld',
    h1: 'Website Relaunch in Bielefeld für Unternehmen, deren alte Website zu wenig bringt',
  ...
  },
  {
    ...
    title: 'Local SEO Bielefeld | Regional besser gefunden werden und mehr Anfragen',
    description: 'Local SEO in Bielefeld für Unternehmen, die regional besser gefunden werden und mehr lokale Anfragen über Google gewinnen möchten.',
    eyebrow: 'Local SEO Bielefeld',
    h1: 'Local SEO in Bielefeld für Unternehmen, die regional mehr Anfragen gewinnen wollen',
  ...
  },
  {
    ...
    title: 'Webentwicklung Bielefeld | Schnelle Websites und saubere Technik',
    description: 'Webentwicklung in Bielefeld für Unternehmen, die eine schnelle, technisch saubere und ausbaufähige Website mit stabiler Grundlage brauchen.',
  ...
  },
  {
    ...
    title: 'Backend Entwicklung Bielefeld | Formulare, Prozesse und Website-Funktionen',
    description: 'Backend Entwicklung in Bielefeld für Websites mit Formularlogik, Prozessen, Datenflüssen oder individuellen Funktionen.',
